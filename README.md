...
All prompts are designed to work with ChatGPT, Claude, Gemini, and other AI assistants.
...
**Why it exists:** This replicates the core features of premium apps like Shortform, but completely free and customizable to your needs.

**Best for:**
- Professionals who read for work
...
3. **Paste into your AI tool** of choice (ChatGPT, Claude, Gemini, etc.)
4. **Follow the prompt's instructions** - most will ask for specific inputs
5. **Customize as needed** - these are starting points, adapt them to your context

### Platform Notes

- **ChatGPT (Plus/Team/Enterprise):** Works great with all prompts. Can save prompts as "Custom GPTs" for repeated use.
- **Claude:** Excellent for longer, more nuanced outputs. Great for the study partner prompt.
- **Gemini:** Good for quick summaries and structured outputs.
- **Copilot:** Better for simpler, shorter prompts. May need to break complex prompts into smaller requests.
...
- **Share how you've adapted these** prompts for your context
...
- **LinkedIn:** https://www.linkedin.com/in/georgebslade/
- **SUBSTACK:** https://substack.com/@gslade
- **bandcamp:** https://gslade.bandcamp.com/
...
If you're in education, IT, or leadership and want to use AI more effectively, I hope these help.
